    ...
    <body>
        ...
        <div class="container" id="localidades">
            <div class="casamento" id="localCerimonia" style="width:40%;">
                ...
                <p class="texto">
                    A Cerimônia acontecerá na Capela de São José, na Vila São José em Içara, Santa Catarina, às 17h30.
                </p>
                        </br>
                        <img src="../../imagens/igreja.png" class="fotoLocal">
                <p class="texto" style="font-size:20px;"><a href="https://goo.gl/maps/CfS2RwiF95f8otFG9" target="_blank">
            ...
            <div class="casamento" id="localCerimonia" style="width:40%; margin-left: 80px;">
                ...
                <p class="texto">
                    A Recepção acontecerá após a Cerimônia e será na Lake Hall, sem hora para acabar.
                </p>
                        </br>
                        <img src="../../imagens/recepcao.png" class="fotoLocal">
                <p class="texto" style="font-size:20px;"><a href="https://goo.gl/maps/dEXi7rdBV7bMhjBTA" target="_blank">
                    Clique aqui para pegar a localização.
                </a></p>
            </div>
        </div>
